            ...
            return this.each(function() {
                ...
                $data.uploadFile = function(file, uploadAll) {
                    if (!file.skip && !file.complete && !file.uploading) {
                        ...
                        if ($.inArray('onUploadFile', settings.overrideEvents) < 0) {
                            // Set the headers
                            ...
                            for (key in settings.formData) {
                                xhr.setRequestHeader('X_' + key, settings.formData[key]);
                            }
                        }
                ...
                $data.error = function(errorType, file, uploadAll) {
                    if ($.inArray('error', settings.overrideEvents) < 0) {
                ...
                if (window.File && window.FileList && window.FileReader && window.Blob) {
                    ...
                    if (settings.dnd) {
                        $data.queueEl.get(0).addEventListener('dragleave', function(e) {
                            // Stop FireFox from opening the dropped file(s)
                            e.preventDefault();
                            e.stopPropagation();
                        }, false);
                        $data.queueEl.get(0).addEventListener('dragenter', function(e) {
                            // Stop FireFox from opening the dropped file(s)
                            e.preventDefault();
                            e.stopPropagation();
                        }, false);
                        $data.queueEl.get(0).addEventListener('dragover', function(e) {
                            // Stop FireFox from opening the dropped file(s)
                            e.preventDefault();
                            e.stopPropagation();
                        }, false);
                        $data.queueEl.get(0).addEventListener('drop', $data.drop, false);
                    }
