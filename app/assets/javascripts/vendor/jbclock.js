    ...
    var clock = {
        set: {
            days: function(){
                ...
                ctx.arc(66,67,60, deg(0), deg((360/glob.total)*(glob.total - glob.days)));
                ctx.lineWidth = 13;
                ctx.stroke();
            ...
            hours: function(){
                ...
                ctx.arc(66,67,60, deg(0), deg(15*glob.hours));
                ctx.lineWidth = 13;
                ctx.stroke();
            ...
            minutes : function(){
                ...
                ctx.arc(66,67,60, deg(0), deg(6*glob.minutes));
                ctx.lineWidth = 13;
                ctx.stroke();
            ...
            seconds: function(){
                ...
                ctx.arc(66,67,60, deg(0), deg(6*glob.seconds));
                ctx.lineWidth = 13;
                ctx.stroke();
